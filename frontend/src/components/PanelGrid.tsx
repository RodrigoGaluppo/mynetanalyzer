...
export default function PanelGrid() {
    ...
    function fetchData() {
      ...
      socket.emit('request_data_24_hours_sum')
      socket.emit('request_data_24_hours_total_packet_count')
    ...
    socket.on('data_update_24_hour_sum', function(data) {
    ...
    socket.on('data_update_last_24_hours_total_packet_count', function(data) {
        ...
        >
          ...
          <StatGroup  >
            <Stat w="100%" >
                ...
                } Hosts <Icon as={BiBox} ml="2" fontSize={"2xl"} /> 
                </StatLabel>
